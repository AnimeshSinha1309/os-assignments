...
void send_setup() {
    ...
    address_s.sin_port = htons(PORT_SERVER);
...
void recieve_setup() {
    ...
    address_r.sin_port = htons(PORT_CLIENT);
...
int main(int argc, char const *argv[]) {
    ...
    recieve_setup();
    while (1) {
        char* buffer = recieve_message();
        printf(COLOR_BLUE "DATA recieved: %s\n" COLOR_RESTORE, buffer);
        char *message = "I am the server, and I Acknowledge your message.";       
